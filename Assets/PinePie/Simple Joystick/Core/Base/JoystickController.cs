...
namespace PinePie.SimpleJoystick
{
    ...
    public class JoystickController : MonoBehaviour, IPointerDownHandler, IPointerUpHandler, IDragHandler
    {
        ...
        [Tooltip("If checked, it should keep the joystick visible even if it isn't set to static")]
        public bool constanlyVisible = false;
        ...
        void Awake()
        {
            ...
            if (baseMode != JoystickBaseMode.Static && !constanlyVisible) joystickBase.gameObject.SetActive(false);
        }
