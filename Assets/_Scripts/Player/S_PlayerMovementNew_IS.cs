...
public class S_PlayerMovementNew_IS : MonoBehaviour
{
    ...
    private void OnEnable()
    {
        ...
        S_InputReader.Movement += Move;
        S_InputReader.TouchedScreen += TouchInputOn;
        S_InputReader.KeyboardPressed += TouchInputOff;
    }
    ...
    private void TouchInputOn()
    {
        if (touchInputCanvas.activeInHierarchy) return;
        touchInputCanvas.SetActive(true);
        JoystickMovementOn();
    }

    private void TouchInputOff()
    {
        if (!touchInputCanvas.activeInHierarchy) return;
    ...
    private void JoystickMovementOn()
    {
        usingControlStick = true;
    }

    private void JoystickMovementOff()
    {
        usingControlStick = false;
    }
