...
{
    [MenuItem("Tools/Export Dialogues (S_TextTriggerSystem)", false, 20)]
    public static void ExportDialogues()
    {
        string savePath = EditorUtility.SaveFilePanel("Save CSV from dialogues", "Assets", "Dialogues_Export.csv", "csv");
        ...
        foreach (string path in scenePaths)
        {
            ...
            // 1. Export S_TextTriggerSystem_MA
        ...
        EditorUtility.DisplayDialog("Close", "Successfully exported dialogues.", "OK");
    }
}